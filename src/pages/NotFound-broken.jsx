impo    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-purple to-brand-dark px-4">
      <div className="bg-white/90 rounded-xl shadow-lg p-8 w-full max-w-md text-center">
        ...
        <p className="text-brand-dark mb-6">The page you're looking for doesn't exist or has moved.</p>k } from 'react-router-dom';
